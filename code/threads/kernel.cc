...
{
    // char *str = "Swapfilename";
    
    // this->fileSystem->Create(str);
    // SwapFile = kernel->fileSystem->Open(str);
    randomSlice = FALSE; 
    debugUserProg = FALSE;
...
Kernel::Initialize()
{
    ...
    bool createSuccess= kernel->fileSystem->Create("SwapFile");
        if (createSuccess) {
            printf("Cretaed successfully\n");
